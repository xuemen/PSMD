...
* 推广
	...
	3. 上次承诺未能兑现的申请者，申请时承诺人数不得超过上次实际完成人数；
	4. 申请者按申请时间先后成为传播者，但所有传播者的承诺总量不得超过传播总需求量。
...
###分配规则
1. 传播者可以在申请时选择报酬方案：
	1. 方案1:承诺引入委托者人数n，如果实际完成m个客户，报酬S为：
         1. m>=n时：S=n\*B+(m-n)\*B\*20%   [注：B是同期同产品的预购者利润。]
         2. m<n时： S=0  
	报酬在下季度初发放。
	2. 方案2: 所引入的委托者在1年内成交量的10%，第二年成交量的7% 。报酬在下年度初发放。
2. 产品经理报酬：
3. 产品立项者报酬：
